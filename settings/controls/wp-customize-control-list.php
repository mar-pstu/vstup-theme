...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WP_Customize_Control_list extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'wp_customize_control_list', get_theme_file_uri( 'wp-customize-control-list.js' ), [ 'jquery', 'customize-preview', 'wp-util', 'jquery-ui-sortable', 'chosen', 'wp-color-picker', 'jquery-ui-datepicker' ], filemtime( get_theme_file_path( 'wp-customize-control-list.js' ) ), true );
			...
			wp_enqueue_style( 'wp_customize_control_list', get_theme_file_uri( 'wp-customize-control-list.css' ), [ 'chosen', 'jquery-ui' ], filemtime( get_theme_file_path( 'wp-customize-control-list.css' ) ), 'all' );
		}
