...
/**
 * Регистрация настроек списка "Список выпускников"
 * */
function register_lists_settings_graduates( $wp_customize ) {
...
add_action( 'customize_register', 'vstup\register_lists_settings_graduates', 10, 1 );