...
/**
 * Регистрация настроек списка "Список Услуг"
 * */
function register_lists_settings_services_items( $wp_customize ) {
...
add_action( 'customize_register', 'vstup\register_lists_settings_services_items', 10, 1 );