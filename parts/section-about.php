...
$label = get_theme_mod( 'aboutlabel' );
$thumbnail_src = get_theme_mod( 'aboutthumbnail' );
$thumbnail_alt = get_bloginfo( 'name' );
$thumbnail_link = get_theme_mod( 'aboutthumbnaillink' );
...
$permalink = get_theme_mod( 'aboutpermalink' );

include get_theme_file_path( 'views/section-about.php' );