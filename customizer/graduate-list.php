...
for ( $i=0; $i<get_theme_mod( "{$slug}_graduates_number", 5 ); $i++ ) { 
	...
	$wp_customize->add_control(
		new WP_Customize_Cropped_Image_Control(
			...
			array(
				...
				'section'       => "{$slug}_graduates",
				'settings'      => "{$slug}_graduate[{$i}][foto]",
				'flex_width'    => false,
				'flex_height'   => false,
				'width'         => 250,
				'height'        => 250,
	...
	$wp_customize->add_setting(
		"{$slug}_graduate[{$i}][specialty][title]",
		array(
			'default'           => '',
			'transport'         => 'reset',
			'sanitize_callback' => 'sanitize_text_field',
	...
	$wp_customize->add_control(
		"{$slug}_graduate[{$i}][specialty][permalink]",
		array(
			'section'           => "{$slug}_graduates",
	...
	$wp_customize->add_setting(
		"{$slug}_graduate[{$i}][specialty][thumbnail]",
		array(
			'default'           => '',
			'transport'         => 'reset',
			'sanitize_callback' => 'sanitize_url',
	...
	$wp_customize->add_control(
		new WP_Customize_Cropped_Image_Control(
			...
			array(
				...
				'section'       => "{$slug}_graduates",
				'settings'      => "{$slug}_graduate[{$i}][specialty][thumbnail]",
				'flex_width'    => false,
				'flex_height'   => false,
				'width'         => 150,
				'height'        => 150,
